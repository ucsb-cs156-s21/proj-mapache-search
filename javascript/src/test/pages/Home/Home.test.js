...
describe("Home tests", () => {
  ...
  test("Have link to nsf research project", () => {
    const { getByText } = render(<Home />);
    expect(getByText("Read More About The Research Project").closest('a')).toHaveAttribute('href', 'https://www.nsf.gov/awardsearch/showAward?AWD_ID=1915198&HistoricalAwards=false')
  })
});
