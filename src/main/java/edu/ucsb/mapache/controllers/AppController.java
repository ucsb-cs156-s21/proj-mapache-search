...
import edu.ucsb.mapache.services.Auth0Service;
import edu.ucsb.mapache.models.GoogleUserProfile;
...
public class AppController {
  ...
  public GoogleUserProfile privateEndpoint(@RequestHeader("Authorization") String authorization) throws Exception {
