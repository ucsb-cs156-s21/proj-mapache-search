...
public class GoogleUserProfile {
  ...
  public boolean equals(Object o) {
    ...
    builder.append(sub, profile.getSub()).append(name, profile.getName()).append(email, profile.getEmail())
        .append(givenName, profile.getGivenName()).append(familyName, profile.getFamilyName())
        .append(nickname, profile.getNickname()).append(picture, profile.getPicture())
        .append(locale, profile.getLocale());
