...
public class GoogleSearchService {
  ...
  public static final String SEARCH_ID = "001539284272632380888:kn5n6ubsr7x";
  ...
  public static boolean isValidApiToken(String token) {
    return (
      token != null && !(token.equals("")) && !(token.equals("invalid token"))
    );
  }

  public void decrementSearchesForUser(AppUser you)
    throws SearchQuotaExceededException {
  ...
  //new function
  public void saveToUserSearchRepository(
    String searchQuery,
