...
public class MessageTests {
  ...
  public void test_toString() {
    ...
    Message m = new Message("sampleType", "sampleSubtype", "sampleTs", "sampleUser", "sampleText",
            "sampleChannel", sup);
    String expected = "Message{type='sampleType', subtype='sampleSubtype', ts='sampleTs', " +
            "user='sampleUser', text='sampleText', channel='sampleChannel', user_profile=" +
            sup + "}";
  ...
  public void test_hashCode_matchesOnSameContent() {
    SlackUserProfile sup = new SlackUserProfile();
    Message m1 = new Message("sampleType", "sampleSubtype", "sampleTs", "sampleUser", "sampleText",
            "sampleChannel", sup);
    Message m2 = new Message("sampleType", "sampleSubtype", "sampleTs", "sampleUser", "sampleText",
            "sampleChannel", sup);
